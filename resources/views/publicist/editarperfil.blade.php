...
@section('contenido')
  <div id="wrapper" class="Editperfil">
        ...
        <form action="{{route('updatePublicist',$publicist->id)}}" method="GET" enctype="multipart/form-data">
            </div>
            @csrf
            @method('PUT')
                ...
                <div class="row">
                 ...
                 <div class="row">
                     <div class="col-12 col-md-6 col-lg-4">
                         <div class="row">
                              <div class="col-12 mb-2">
                                  ...
                                  <input type="file" class="cargarImagen" name="main_photo" value="{{$publicist->main_photo}}">
                            <figure class="card-image">
                              @if($publicist->main_photo)
                                <img class="rounded-0" src="{{$publicist->main_photo}}" width="100%" alt="">
                              @else
                                <img class="rounded-0" src="{{asset('img/-add-a-photo_90549.svg')}}" width="100%" alt="">
                              @endif
                            </figure>
                        ...
                        <div class="row px-3">
                            ...
                            <div class="card-body py-3 px-0">
                              <div class="form-group">
                                  <select class="custom-select rounded-0 barroka-bg {{ $errors->has('gender_id') ? ' is-invalid' : '' }}" name="gender">
                                  <option value="">Genero</option>
                                    <option value="HOMBRE" {{$publicist->gender == 'HOMBRE' ? 'selected' : ''}} >Hombre</option>
                                    <option value="MUJER" {{$publicist->gender == 'MUJER' ? 'selected' : ''}}>Mujer</option>
                                </select>
                    ...
                    <select class="custom-select rounded-0 barroka-bg{{ $errors->has('province_id') ? ' is-invalid' : '' }}" id="select-province" name="province_id">
                                  ...
                                  <option  value="{{$province->id}}" {{$publicist->province_id ? 'selected' : ''}} >{{$province->provincia}}</option>
                                  @endforeach
                                </select> 
                                ...
                                @endif
                                  ...
                                  <option value="{{$publicist->city_id}}" selected>{{$publicist->city->localidad}}</option>
                                </select>
                                ...
                                @endif
                                   ...
                                   <div class="form-group">
                                       <input type="text" placeholder="Zona" class="barroka-pink-bg form-control rounded-0{{ $errors->has('zone') ? ' is-invalid' : '' }}" name="zone"
                                        value="{{$publicist->zone}}">
                                        @if ($errors->has('zone'))
                                          <span class="invalid-feedback">
                                   ...
                                   <div class="form-group">
                                       <input type="text" placeholder="Nombre de fantasia" class="barroka-pink-bg form-control rounded-0{{ $errors->has('fancy_name') ? ' is-invalid' : '' }}" name="fancy_name" value="{{$publicist->fancy_name}}">
                                   ...
                                   <div class="form-group">
                                       <input type="text" placeholder="Edad" class="barroka-pink-bg form-control rounded-0{{ $errors->has('age') ? ' is-invalid' : '' }}" name="age" value="{{$publicist->age}}">
                                       @if ($errors->has('age'))
                                          <span class="invalid-feedback">
                                   ...
                                   <div class="form-group">
                                       <input type="text" placeholder="Altura" class="barroka-pink-bg form-control rounded-0{{ $errors->has('height') ? ' is-invalid' : '' }}" name="height" value="{{$publicist->height}}">
                                   ...
                                   <div class="form-group">
                                       <input type="text" placeholder="Medidas" class="barroka-pink-bg form-control rounded-0{{ $errors->has('measurements') ? ' is-invalid' : '' }}" name="measurements" value="{{$publicist->measurements}}">
                                    ...
                                    <hr>
                                    <div class="form-group">
                                       <input type="text" placeholder="Horarios" class="barroka-pink-bg form-control rounded-0{{ $errors->has('schedules') ? ' is-invalid' : '' }}" name="schedules" value="{{$publicist->schedules}}">
                                   ...
                                   <div class="form-group">
                                       <input type="text" placeholder="Telefono" class="barroka-pink-bg form-control rounded-0{{ $errors->has('age') ? ' is-invalid' : '' }}"" name="phone" value="{{$publicist->phone}}">
                                       @if ($errors->has('age'))
                                          <span class="invalid-feedback">
                                            <strong>{{ $errors->first('age') }}</strong>
                                          </span>
                                   ...
                                   <div class="form-group">
                                       <input type="text" placeholder="Tarifa" class="barroka-pink-bg form-control rounded-0{{ $errors->has('rate') ? ' is-invalid' : '' }}" name="rate" value="{{$publicist->rate}}">
                                       @if ($errors->has('rate'))
                                          <span class="invalid-feedback">
                                   ...
                                   <div class="form-group">
                                       <input type="text" placeholder="Medios de pago" class="barroka-pink-bg form-control rounded-0{{ $errors->has('payment_methods') ? ' is-invalid' : '' }}" name="payment_methods" value="{{$publicist->payment_methods}}">
                     ...
                     <div class="col-12 col-md-6 col-lg-4">
                         <div class="row">
                            ...
                            <div class="card-body">
                                <div class="saludo">
                                    <textarea name="presentation" class="form-control rounded-0{{ $errors->has('presentation') ? ' is-invalid' : '' }}" placeholder="Escribe tu mensaje..." id="" cols="30" rows="10">{{$publicist->presentation}}</textarea>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <ul class="list-group">
  <li class="list-group-item"><i class="fab fa-facebook-f"></i> Facebook - URL: <input type="text" placeholder="Escribe la URL de tu perfil" class="form-control" name="facebook" value="{{$publicist->facebook}}"></li>
    <li class="list-group-item"><i class="fab fa-twitter"></i> Twitter - URL: <input type="text" placeholder="Escribe la URL de tu perfil" class="form-control" name="twitter" value="{{$publicist->twitter}}"></li>
    <li class="list-group-item"><i class="fab fa-instagram"></i> Instagram - URL: <input type="text" placeholder="Escribe la URL de tu perfil" class="form-control" name="instagram" value="{{$publicist->instagram}}"></li>
</ul>
      </div>
